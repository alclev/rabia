...
make clean; make
make clean; make
./bin/rabia 2>error.log
exit
make clean
exit
apt-cache show libspdlog-dev
exit
make
make
make
...
/*
  ...
  step 2, run
    ...
    if you get some timeout error, try:;       git clone https://github.com/protocolbuffers/protobuf-go.git;       rename the protobuf-go folder to protobuf, and put it under $GOPATH/src/google.golang.org;       run: go install google.golang.org/protobuf/cmd/protoc-gen-go;    step 3, see: https://github.com/gogo/protobuf#speed
    run the followings to instal gogo-protobuf:;       go get github.com/gogo/protobuf/protoc-gen-gofast;       go get github.com/gogo/protobuf/protoc-gen-gogofaster;       go get github.com/gogo/protobuf/protoc-gen-gogoslick;     you can even install more extensions, check https://github.com/gogo/protobuf#more-speed-and-more-generated-code
   step 4, modify this file and comment/uncomment gogo-protobuf/protobuf headers of this file according to the use case;    step 5, to recompile this file, run:;     cd ~/go/src/rabia/internal/message;      if you want to use gogo-protobuf:;       protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/gogo/protobuf/protobuf --gogoslick_out=. ./message.proto;      if you want to use the vanilla protobuf:;       protoc -I=. -I=$GOPATH/src -I=<path to the unzip-ed include folder>/google/protobuf --go_out=. ./message.proto;     mine is:;       protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/google/protobuf --go_out=. ./message.proto;  */;  /*;   gogo-protobuf header (please comment out the vanilla protobuf header)
*/
package message;
